...
- Может ли в роли стратегии выступать абстрактный класс вместо интерфейса?
  В каких случаях это имело бы смысл?
- Может ли класс стратегии иметь состояние?
  Если да, то приведите пример, когда это имело бы смысл.
...
- Кто инициирует переходы между классами в паттерне "Состояние"?
