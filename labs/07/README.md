...
Это значит, что пользователь должен иметь возможность изменить у стиля группы одно из свойств,
не меняя состояние других. Например, изменить толщину обводки, оставив её цвет неизменным.
