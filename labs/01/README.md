...
- На оценку «удовлетворительно» необходимо набрать 200 баллов.
...
Внимание, архитектура программы должна позволять легко изменять (изменив буквально несколько строк кода)
поведение утки так, чтобы летающие утки крякали от удовольствия **перед** каждым чётным или нечётным полётом,
а не после него.
...
с архитектурной точки зрения это будет неправильным, так как появится связь между "крыльями" и "клювом".
