...
Бонус начисляется за наличие теста для метода Duck::Dance.
...
Внимание, архитектура программы должна с легкостью (изменив буквально несколько строк кода) изменить поведение утки так,
чтобы летающие утки крякали от удовольствия перед каждым чётным или нечётным полётом.
